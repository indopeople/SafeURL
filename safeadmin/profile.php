      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="box box-primary">
           ...
           if($xprofile){
            $sagiri_query = mysqli_query($rzcon,"UPDATE tbl_admin SET name='$sagiri1', email='$sagiri2' WHERE userid='$sagiriid'");
            if($sagiri_query){
           ...
           if($xpass){
             if($sagiri1 == "" || $sagiri2 == "" || $sagiri3 == ""){
              ...
              $sagiri_query = mysqli_query($rzcon,"SELECT * FROM tbl_admin WHERE upass=md5('$sagiri1')");
              if (mysqli_num_rows($sagiri_query) == 1) {
              if($sagiri2 == $sagiri3){
                $sagiri_kawai = mysqli_query($rzcon, "UPDATE tbl_admin SET upass='$sagiribarumd5'");
                if ($sagiri_kawai) {
                  echo '<div class="callout callout-success">
