         ...
         <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List Link Safe</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>               
                  ...
                  <td><a href="./list_safeurl.php?do=remove&act=safeid&safeid=<?php echo $row['safeid'];;?>" class="btn btn-danger"><i class="fa fa-remove"></a></td>
                </tr>
                <?php
                   }
            
                   }
                   $hapus = @$_REQUEST['do'] == "remove";
                   if($hapus){
                    echo "Hapus data ini?";
                   }
                  ?>
